...
~2936215   assign mem_req_o = (select_i == CLIENT_DESC) ? desc_req_i :
~2352799                      (select_i == CLIENT_CONV) ? conv_req_i :
~2226031                      (select_i == CLIENT_VEC)  ? vec_req_i  :
~2176957                      (select_i == CLIENT_BIAS) ? bias_req_i : dma_req_i;
~2936215   assign mem_we_o = (select_i == CLIENT_DESC) ? desc_we_i :
~2352799                     (select_i == CLIENT_CONV) ? 1'b0 :
~2226031                     (select_i == CLIENT_VEC)  ? vec_we_i :
~2176957                     (select_i == CLIENT_BIAS) ? bias_we_i : dma_we_i;
~2936215   assign mem_addr_o = (select_i == CLIENT_DESC) ? desc_addr_i :
~2352799                       (select_i == CLIENT_CONV) ? conv_addr_i :
~2226031                       (select_i == CLIENT_VEC)  ? vec_addr_i :
~2176957                       (select_i == CLIENT_BIAS) ? bias_addr_i : dma_addr_i;
~2936215   assign mem_wdata_o = (select_i == CLIENT_DESC) ? desc_wdata_i :
~2352799                        (select_i == CLIENT_CONV) ? 32'd0 :
~2226031                        (select_i == CLIENT_VEC)  ? vec_wdata_i :
~2176957                        (select_i == CLIENT_BIAS) ? bias_wdata_i : dma_wdata_i;
~2936215   assign mem_wstrb_o = (select_i == CLIENT_DESC) ? desc_wstrb_i :
~2352799                        (select_i == CLIENT_CONV) ? 4'd0 :
~2226031                        (select_i == CLIENT_VEC)  ? vec_wstrb_i :
~2176957                        (select_i == CLIENT_BIAS) ? bias_wstrb_i : dma_wstrb_i;
...
~3125671     if ((select_i == CLIENT_CONV) && conv_req_i)
~043170       assert (!mem_we_o);
          end
        `endif
